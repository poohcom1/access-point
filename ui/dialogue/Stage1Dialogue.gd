...
const text1 = [
	...
	},
	{
		"s": "MARS",
		"t":[
		"This is agent 067-Mars with the Galactic Trade Task Force. Are you able to receive my transmission?"
		]
	},
	{
		"s": "UNKNOWN",
		"t":[
		"Oh thank god! Yes! Yes, we can pick up your transmission agent...Mars. This is radio operator...Aeonia from the North-Central command bunker. So the GTTF picked up our distress call? We need backup ASAP."
		]
	},
	{
		"s": "MARS",
		"t":[
		"Unfortunately, I am all the backup you get for now. The distress call could not be fully deciphered so I am only here as recon for the area. Care to explain what I was just attacked by moments ago?"
		]
	},
	{
		"s": "AEONIA",
	...
	},
	{
		"s": "AEONIA",
		"t":[
		"We have been sending out messages on all frequencies regularly since main comms cut out. You are the first response we have had back."
		]
	},
	{
		"s": "MARS",
	...
	},
	{
		"s": "AEONIA",
		"t":[
		"Negative. We have no systems online that can track your position. However, you should be able to follow the radar waypoints back to base. That's how all our comms get transmitted on-world."
		]
	},
	{
		"s": "MARS",
